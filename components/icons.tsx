...
// Skill icons are now imported from react-icons
export const MySqlIcon = SiMysql;
export const TensorFlowIcon = SiTensorflow;
export const PyTorchIcon = SiPytorch;
export const PythonIcon = SiPython;
export const RLangIcon = SiR;
export const KerasIcon = SiKeras;
export const NLTKIcon = IoChatbubblesOutline;
